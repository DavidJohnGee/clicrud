...
class _attributes(dict):
    ...
    def get_attributes(self, **kwargs):
        ...
        logging.info("[attributes.py] Detected number of devices %s", % _ndevices)
        ...
        for dev in (_tmp):
            ...
            if _devcount < _ndevices:
                _devcount += 1
            logging.info("[attributes.py] Detected serial number %s", % _tmp2[3])
    ...
    def set_attribute(self, **kwargs):
        ...
        logging.info("[attributes.py] Manually set attribute: %s: %s", _parameter, _value)
